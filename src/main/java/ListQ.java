...
//
//            if (prel1.val + prel2.val + carry >= 10) {
//                prel1.val = prel1.val + prel2.val + carry - 10;
//                carry = 1;
//
//            } else if (carry == 1) {
//                prel1.val = prel1.val + prel2.val + carry;
//                carry = 0;
//            } else {
//                carry = 0;
//                prel1.val = prel1.val + prel2.val;
//            }
//
////            if(carry == 1){
////                prel1.val = prel1.val + prel2.val +carry;
////                carry = 0;
////            }else if(prel1.val + prel2.val >= 10){
////                carry = 1;
////                prel1.val = prel1.val + prel2.val - 10;
////            }else{
////                prel1.val = prel1.val + prel2.val;
////            }
//
...
//        }
//
//        if ((prel1 == null && prel2 != null) || (prel1 != null && prel2 == null)) {
//            return null;
//        }
//
//        if(prel1.val + prel2.val + carry >= 10){
